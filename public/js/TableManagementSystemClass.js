...
TableManagementSystem.prototype.updateUI = function (optionalTableNumber) {
   ...
   var updateUI_singleTable = (tableNum) => {
      ...
      $("#" + this.TABLE_ID_PREFIX + tableNum).attr("style", "fill:" + colors[this.tableStates[tableNum - 1]]);
   };
...
TableManagementSystem.prototype.getTable = function (tableNum) {
   var tableNumber = parseInt(tableNum.replace(/[^0-9]/gi, ""));
   return this.tableStates[tableNumber - 1];
};

TableManagementSystem.prototype.getTableState = TableManagementSystem.prototype.getTable;
...
TableManagementSystem.prototype.getActualNumber = function (str) {
   return str.replace(/[^0-9]/gi, "");
};

TableManagementSystem.prototype.advanceTable = function (tableNum) {
   var tableNumber = this.getActualNumber(tableNum);
